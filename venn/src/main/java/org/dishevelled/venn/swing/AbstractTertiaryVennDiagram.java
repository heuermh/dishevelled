    ...
    extends LabelFieldPanel
{
    ...
    /** Default label text for the second set, <code>"Third set"</code>. */
    ...
    /** Default label text for the second only view, <code>"Third only"</code>. */
...
7
                                          ...
                                          final String thirdLabelText, final Set<? extends E> third)
    {
        ...
        this.firstSecondLabelText = firstLabelText + " " + secondLabelText + " only";
        this.secondThirdLabelText = secondLabelText + " " + thirdLabelText + " only";
