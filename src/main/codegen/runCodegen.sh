#!/bin/bash
velocity.sh --properties "lower0=first,lower1=second,lower2=third,Upper0=First,Upper1=Second,Upper2=Third,UPPER0=FIRST,UPPER1=SECOND,UPPER2=THIRD" --template ternaryNode.wm
velocity.sh --properties "lower0=first,lower1=second,lower2=fourth,Upper0=First,Upper1=Second,Upper2=Fourth,UPPER0=FIRST,UPPER1=SECOND,UPPER2=FOURTH" --template ternaryNode.wm
velocity.sh --properties "lower0=first,lower1=third,lower2=fourth,Upper0=First,Upper1=Third,Upper2=Fourth,UPPER0=FIRST,UPPER1=THIRD,UPPER2=FOURTH" --template ternaryNode.wm
velocity.sh --properties "lower0=second,lower1=third,lower2=fourth,Upper0=Second,Upper1=Third,Upper2=Fourth,UPPER0=SECOND,UPPER1=THIRD,UPPER2=FOURTH" --template ternaryNode.wm
