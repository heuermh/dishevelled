 ...
 */
public class VetoableNavigableSetChangeEvent<E>
    extends EventObject
{

    /**
     * Create a new vetoable navigable set change event with the
     * specified observable navigable set as the event source.
     *
     * @param source source of the event
     */
    public VetoableNavigableSetChangeEvent(final ObservableNavigableSet<E> source)
    {
        super(source);
    }
    ...
    /**
     * Return the source of this vetoable navigable set change event as an
