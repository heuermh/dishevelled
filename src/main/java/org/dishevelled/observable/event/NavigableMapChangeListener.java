 ...
 * made to an observable navigable map.
 *
 ...
 */
public interface NavigableMapChangeListener<K,V>
    extends EventListener
{

    /**
     * Notify this listener that a change has been
     * made to the observable navigable map.
     *
     * @param e navigable map change event
     */
    void navigableMapChanged(NavigableMapChangeEvent<K,V> e);
}
