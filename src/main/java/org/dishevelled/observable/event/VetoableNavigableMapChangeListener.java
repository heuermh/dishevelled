 ...
 * changes about to be made to an observable navigable map.
 *
 ...
 */
public interface VetoableNavigableMapChangeListener<K,V>
    extends EventListener
{

    /**
     * Notify this listener that a vetoable change is about
     * to be made to the observable navigable map.
     *
     * @param e vetoable navigable map change event
     * @throws NavigableMapChangeVetoException if this listener wishes
     *    the change about to be made to be rolled back
     */
    void navigableMapWillChange(VetoableNavigableMapChangeEvent<K,V> e)
