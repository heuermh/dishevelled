 ...
 * changes about to be made to an observable navigable set.
 *
 * @param <E> navigable set element type
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public interface VetoableNavigableSetChangeListener<E>
    extends EventListener
{

    /**
     * Notify this listener that a vetoable change is about
     * to be made to the observable navigable set.
     *
     * @param e vetoable navigable set change event
     * @throws NavigableSetChangeVetoException if this listener wishes
     *    the change about to be made to be rolled back
     */
    void navigableSetWillChange(VetoableNavigableSetChangeEvent<E> e)
