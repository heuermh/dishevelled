 ...
 * changes about to be made to an observable deque.
 *
 * @param <E> deque element type
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public interface VetoableDequeChangeListener<E>
    extends EventListener
{

    /**
     * Notify this listener that a vetoable change is about
     * to be made to the observable deque.
     *
     * @param e vetoable deque change event
     * @throws DequeChangeVetoException if this listener wishes
     *    the change about to be made to be rolled back
     */
    void dequeWillChange(VetoableDequeChangeEvent<E> e)
