...
/**
 * Observable extension to the <code>Deque</code> interface.
 *
 * @param <E> deque element type
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public interface ObservableDeque<E>
    extends Deque<E>
{
     ...
     */
    void addDequeChangeListener(DequeChangeListener<E> l);
     ...
     */
    void removeDequeChangeListener(DequeChangeListener<E> l);
     ...
     */
    void addVetoableDequeChangeListener(VetoableDequeChangeListener<E> l);
     ...
     */
    void removeVetoableDequeChangeListener(VetoableDequeChangeListener<E> l);
     ...
     *    an empty array if none are registered
     */
    DequeChangeListener<E>[] getDequeChangeListeners();

    /**
     * Return the number of <code>DequeChangeListener</code>s registered
     * to this observable deque.
     *
     * @return the number of <code>DequeChangeListener</code>s registered
     *    to this observable deque
     */
    int getDequeChangeListenerCount();
     ...
     *    or an empty array if none are registered
     */
    VetoableDequeChangeListener<E>[] getVetoableDequeChangeListeners();

    /**
     * Return the number of <code>VetoableDequeChangeListener</code>s
     * registered to this observable deque.
     *
     * @return the number of <code>VetoableDequeChangeListener</code>s
     *    registered to this observable deque
     */
    int getVetoableDequeChangeListenerCount();
}
