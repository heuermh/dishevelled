...
import org.dishevelled.color.scheme.interpolate.Log2Interpolation;
    ...
    extends TestCase
{
    ...
    {
        assertNotNull(new Log2Interpolation());
    }

    public void testInterpolate()
    {
        Log2Interpolation interpolation = new Log2Interpolation();
