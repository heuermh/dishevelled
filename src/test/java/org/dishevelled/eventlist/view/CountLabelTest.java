...
/**
 * Unit test for CountLabel.
 */
public final class CountLabelTest
{
    private EventList<String> elements;
    private CountLabel<String> countLabel;

    @Before
    public void setUp()
    {
        elements = GlazedLists.eventListOf("foo", "bar", "baz");
        countLabel = new CountLabel<String>(elements);
    }
