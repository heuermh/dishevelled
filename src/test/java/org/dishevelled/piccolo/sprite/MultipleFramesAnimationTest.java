...
/**
 * Unit test for MultipleFramesAnimation.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class MultipleFramesAnimationTest
    extends TestCase
{
    ...
    public void testConstructor()
    {
        ...
        Animation animation0 = new MultipleFramesAnimation(images);

        try
        {
            Animation animation = new MultipleFramesAnimation(null);
        ...
        try
        {
            ...
            Animation animation = new MultipleFramesAnimation(empty);
    ...
    public void testMultipleFrames()
    {
        ...
        MultipleFramesAnimation animation = new MultipleFramesAnimation(images);
        assertNotNull("animation not null", animation);
        assertNotNull("animation currentFrame not null", animation.getCurrentFrame());
