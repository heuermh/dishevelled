...
/**
 * Abstract unit test for implementations of Matrix1DReader.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public abstract class AbstractMatrix1DReaderTest
    extends TestCase
{

    /**
     * Create and return a new instance of an implementation of Matrix1DReader to test.
     *
     * @return a new instance of an implementation of Matrix1DReader to test
     */
    protected abstract <T> Matrix1DReader<T> createMatrix1DReader();


    public void testCreateMatrix1DReader()
    {
        Matrix1DReader<String> reader = createMatrix1DReader();
