...
/**
 * Unit test for VennLayoutUtils.
 *
 * @author  Michael Heuer
 */
public final class VennLayoutUtilsTest
    extends TestCase
{

    public void testToImmutableBitSet()
    {
        ImmutableBitSet bitSet = VennLayoutUtils.toImmutableBitSet(0, 2, 4);
    ...
    {
        ImmutableBitSet bitSet = VennLayoutUtils.toImmutableBitSet(0);
        assertTrue(bitSet.getQuick(0));
    }

    public void testToImmutableBitSetNullAdditional()
    {
        ImmutableBitSet bitSet = VennLayoutUtils.toImmutableBitSet(0, null);
        assertTrue(bitSet.getQuick(0));
    }
}