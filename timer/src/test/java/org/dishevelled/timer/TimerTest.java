    ...
    extends TestCase
{
    ...
    public void testTimer()
    {
        ...
        assertEquals("t size == 0", 0L, t.size());
        assertEquals("t min == Double.NaN", Double.NaN, t.min());
        assertEquals("t max == Double.NaN", Double.NaN, t.max());
        assertEquals("t sum == Double.NaN", Double.NaN, t.sum());
        ...
        t.stop();
        assertEquals("t size == 1", 1L, t.size());
        ...
        assertEquals("t standardDeviation == 0.0d", 0.0d, t.standardDeviation());
        ...
        assertEquals("t size == 5", 5L, t.size());
        assertTrue("t min > 0.0d", t.min() > 0.0d);
        assertTrue("t max > 0.0d", t.max() > 0.0d);
        assertTrue("t sum > 0.0d", t.sum() > 0.0d);
        assertTrue("t mean > 0.0d", t.mean() > 0.0d);
    ...
    public void testMultipleStop()
    {
        ...
        t.stop();
        t.stop();
        assertEquals("t size == 3", 3L, t.size());
    ...
    public void testTime()
    {
        ...
        assertEquals("t0 size == 1", 1L, t0.size());
        ...
        assertEquals("t0 standardDeviation == 0.0d", 0.0d, t0.standardDeviation());

        assertEquals("t1 size == 1", 1L, t1.size());
        ...
        assertEquals("t1 standardDeviation == 0.0d", 0.0d, t1.standardDeviation());

        assertEquals("t2 size == 1", 1L, t2.size());
        ...
        assertEquals("t2 standardDeviation == 0.0d", 0.0d, t2.standardDeviation());

        Timer.time(r0, t0);
        Timer.time(r1, t1);
        Timer.time(r2, t2);

        assertEquals("t0 size == 2", 2L, t0.size());
        assertTrue("t0 min > 0.0d", t0.min() > 0.0d);
        assertTrue("t0 max > 0.0d", t0.max() > 0.0d);
        assertTrue("t0 sum > 0.0d", t0.sum() > 0.0d);
        assertTrue("t0 mean > 0.0d", t0.mean() > 0.0d);
        ...
        assertEquals("t1 size == 2", 2L, t1.size());
        assertTrue("t1 min > 0.0d", t1.min() > 0.0d);
        assertTrue("t1 max > 0.0d", t1.max() > 0.0d);
        assertTrue("t1 sum > 0.0d", t1.sum() > 0.0d);
        assertTrue("t1 mean > 0.0d", t1.mean() > 0.0d);
        ...
        assertEquals("t2 size == 2", 2L, t2.size());
        assertTrue("t2 min > 0.0d", t2.min() > 0.0d);
        assertTrue("t2 max > 0.0d", t2.max() > 0.0d);
        assertTrue("t2 sum > 0.0d", t2.sum() > 0.0d);
        assertTrue("t2 mean > 0.0d", t2.mean() > 0.0d);
    ...
    public void testLoop()
    {
        ...
        assertEquals("t0 size == 500", 500L, t0.size());
        assertTrue("t0 min > 0.0d", t0.min() > 0.0d);
        assertTrue("t0 max > 0.0d", t0.max() > 0.0d);
        assertTrue("t0 sum > 0.0d", t0.sum() > 0.0d);
        assertTrue("t0 mean > 0.0d", t0.mean() > 0.0d);
        ...
        assertEquals("t1 size == 50", 50L, t1.size());
        assertTrue("t1 min > 0.0d", t1.min() > 0.0d);
        assertTrue("t1 max > 0.0d", t1.max() > 0.0d);
        assertTrue("t1 sum > 0.0d", t1.sum() > 0.0d);
        assertTrue("t1 mean > 0.0d", t1.mean() > 0.0d);
        ...
        assertEquals("t2 size == 5", 5L, t2.size());
        assertTrue("t2 min > 0.0d", t2.min() > 0.0d);
        assertTrue("t2 max > 0.0d", t2.max() > 0.0d);
        assertTrue("t2 sum > 0.0d", t2.sum() > 0.0d);
        assertTrue("t2 mean > 0.0d", t2.mean() > 0.0d);
        ...
        assertEquals("t0 size == 1000", 1000L, t0.size());
        assertEquals("t1 size == 100", 100L, t1.size());
        assertEquals("t2 size == 10", 10L, t2.size());
    }
    ...
    public void testLoopOver()
    {
        ...
        assertEquals("map0 size == 3", 3L, map0.size());
        ...
        assertEquals("t0 size == 10", 10L, t0.size());
        assertTrue("t0 min > 0.0d", t0.min() > 0.0d);
        assertTrue("t0 max > 0.0d", t0.max() > 0.0d);
        assertTrue("t0 sum > 0.0d", t0.sum() > 0.0d);
        assertTrue("t0 mean > 0.0d", t0.mean() > 0.0d);
        ...
        assertEquals("t1 size == 10", 10L, t1.size());
        assertTrue("t1 min > 0.0d", t1.min() > 0.0d);
        assertTrue("t1 max > 0.0d", t1.max() > 0.0d);
        assertTrue("t1 sum > 0.0d", t1.sum() > 0.0d);
        assertTrue("t1 mean > 0.0d", t1.mean() > 0.0d);
        ...
        assertEquals("map1 size == 3", 3L, map1.size());
        ...
        assertEquals("t3 size == 10", 10L, t3.size());
        ...
        assertEquals("t4 size == 10", 10L, t4.size());
        ...
        assertEquals("t5 size == 10", 10L, t5.size());
