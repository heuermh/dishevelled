...
/**
 * JTextComponent with KEY_TEXT_ANTIALIASING set to VALUE_TEXT_ANTIALIAS_LCD_VBGR.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class JTextComponentAntialiasingLcdVbgr
    extends AbstractJTextComponentTextRenderingBenchmark
{
    ...
    {
        return "jtextcomponent-lcd-vbgr";
    }
