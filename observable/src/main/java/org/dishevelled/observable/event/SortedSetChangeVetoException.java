...
/**
 * Exception thrown in the event a sorted set change
 * is vetoed by a <code>VetoableSortedSetChangeListener</code>.
 *
    ...
    implements Serializable
{
     ...
     */
    public SortedSetChangeVetoException(final String message)
    {
        super(message);
    }
}
