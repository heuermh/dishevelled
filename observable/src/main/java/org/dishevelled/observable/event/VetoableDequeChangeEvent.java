 ...
 */
public class VetoableDequeChangeEvent<E>
    extends EventObject
{

    /**
     * Create a new vetoable deque change event with the
     * specified observable deque as the event source.
     *
     * @param source source of the event
     */
    public VetoableDequeChangeEvent(final ObservableDeque<E> source)
    {
        super(source);
    }
    ...
    /**
     * Return the source of this vetoable deque change event as an
