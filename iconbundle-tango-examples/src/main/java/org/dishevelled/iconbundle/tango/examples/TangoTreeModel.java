    ...
    implements TreeModel
{
    ...
    private void initializeMultiMap()
    {
        ...
        //multiMap.put("actions", new Icon("view-refresh", TangoProject.VIEW_FULLSCREEN));
        ...
        //multiMap.put("categories", new Icon("preferences-desktop-accessibility", TangoProject.PREFERENCES_DESKTOP_ACCESSIBILITY));
