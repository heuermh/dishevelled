    ...
    public void run(final TaskMonitor taskMonitor)
    {
        ...
        try
        {
            ...
            for (int i = 0, size = model.variations().size(); i < size; i++)
            {
                ...
                {
                    taskMonitor.setStatusMessage("Predicting variation consequences for variation " + variation.getRegion() + ":" + variation.getStart() + "-" + variation.getEnd() + " " + variation.getAlternateAlleles() + "...");
                    ...
                    taskMonitor.setStatusMessage("Predicted " + variationConsequences.size() + " variation consequences for variation " + variation.getRegion() + ":" + variation.getStart() + "-" + variation.getEnd() + " " + variation.getAlternateAlleles() + "...");
