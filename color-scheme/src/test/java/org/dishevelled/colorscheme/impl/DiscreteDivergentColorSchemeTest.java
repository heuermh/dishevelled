    ...
    extends TestCase
{
    ...
    public void testConstructor()
    {
        ...
        new DiscreteDivergentColorScheme("color-scheme", colors, 1.0d, 50.0d, 99.0d, colorFactory, Interpolations.LINEAR);
        new DiscreteDivergentColorScheme("color-scheme", colors, -99.0d, -50.0d, -1.0d, colorFactory, Interpolations.LINEAR);
        new DiscreteDivergentColorScheme("color-scheme", colors, -1 * Double.MAX_VALUE, 0.0d, Double.MAX_VALUE, colorFactory, Interpolations.LINEAR);
        //new DiscreteDivergentColorScheme("color-scheme", colors, Double.NaN, 0.5d, 1.0d, colorFactory, Interpolations.LINEAR);
        //new DiscreteDivergentColorScheme("color-scheme", colors, 0.0d, 0.5d, Double.NaN, colorFactory, Interpolations.LINEAR);
        new DiscreteDivergentColorScheme(null, colors, 0.0d, 0.5d, 1.0d, colorFactory, Interpolations.LINEAR);

        try
        {
            new DiscreteDivergentColorScheme("color-scheme", null, 0.0d, 0.5d, 1.0d, colorFactory, Interpolations.LINEAR);
        ...
        try
        {
            new DiscreteDivergentColorScheme("color-scheme", emptyColors, 0.0d, 0.5d, 1.0d, colorFactory, Interpolations.LINEAR);
        ...
        try
        {
            new DiscreteDivergentColorScheme("color-scheme", singletonColor, 0.0d, 0.5d, 1.0d, colorFactory, Interpolations.LINEAR);
        ...
        try
        {
            new DiscreteDivergentColorScheme("color-scheme", colors, 0.0d, 0.5d, 1.0d, null, Interpolations.LINEAR);
            fail("ctr(,,,,null,) expected IllegalArgumentException");
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            new DiscreteDivergentColorScheme("color-scheme", colors, 0.0d, 0.5d, 1.0d, colorFactory, null);
            fail("ctr(,,,,,null) expected IllegalArgumentException");
        }
        catch (IllegalArgumentException e)
        {
    ...
    {
        //ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", createList(Color.BLACK, Color.WHITE) 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
        ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", newArrayList(Color.BLACK, Color.WHITE), 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
    ...
    {
        //ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", createList(Color.BLACK, Color.RED, Color.BLUE, Color.WHITE), 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
        ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", newArrayList(Color.BLACK, Color.RED, Color.BLUE, Color.WHITE), 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
        assertNotNull(colorScheme);
        //assertEquals("name", colorScheme.getName());
        // out of bounds
        assertEquals(Color.BLACK, colorScheme.getColor(-1.0d));
    ...
    {
        //ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", createList(Color.BLACK, Color.RED, Color.WHITE), 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
        ColorScheme colorScheme = new DiscreteDivergentColorScheme("name", newArrayList(Color.BLACK, Color.RED, Color.WHITE), 0.0d, 0.5d, 1.0d, new DefaultColorFactory(), Interpolations.LINEAR);
        assertNotNull(colorScheme);
        //assertEquals("name", colorScheme.getName());
        // out of bounds
        assertEquals(Color.BLACK, colorScheme.getColor(-1.0d));
