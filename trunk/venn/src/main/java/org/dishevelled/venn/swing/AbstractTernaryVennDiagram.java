    ...
    extends LabelFieldPanel
{
    ...
    /**
     * Create a new empty abstract ternary venn diagram.
     */
    protected AbstractTernaryVennDiagram()
    {
        super();
    ...
    /**
     * Create a new abstract ternary venn diagram with the specified sets.
     *
     ...
     */
    protected AbstractTernaryVennDiagram(final String firstLabelText, final Set<? extends E> first,
    ...
    /**
     * Create a new abstract ternary venn diagram with the specified model.
     *
     * @param model model for this abstract ternary venn diagram, must not be null
     */
    protected AbstractTernaryVennDiagram(final TernaryVennModel3<E> model)
    {
        super();
        if (model == null)
        {
