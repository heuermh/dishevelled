 ...
 */
public final class SparseTextMatrix1DReader<E>
    extends AbstractSparseTextMatrix1DReader<E>
{
    /** Parser function. */
     ...
     */
    public SparseTextMatrix1DReader(final UnaryFunction<String, ? extends E> parser)
    {
        if (parser == null)
        {
