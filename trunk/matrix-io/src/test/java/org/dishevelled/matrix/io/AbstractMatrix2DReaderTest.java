...
/**
 * Abstract unit test for implementations of Matrix2DReader.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public abstract class AbstractMatrix2DReaderTest
    extends TestCase
{

    /**
     * Create and return a new instance of an implementation of Matrix2DReader to test.
     *
     * @return a new instance of an implementation of Matrix2DReader to test
     */
    protected abstract <T> Matrix2DReader<T> createMatrix2DReader();


    public void testCreateMatrix2DReader()
    {
        Matrix2DReader<String> reader = createMatrix2DReader();
