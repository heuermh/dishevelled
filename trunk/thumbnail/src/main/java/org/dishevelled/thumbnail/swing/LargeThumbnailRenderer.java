 ...
 */
public final class LargeThumbnailRenderer implements Renderer
{
    /** Thumbnail manager. */
    ...
    /**
     * Create a new large thumbnail renderer with the specified thumbnail manager.
     *
     * @param thumbnailManager thumbnail manager, must not be null
     */
    public LargeThumbnailRenderer(final ThumbnailManager thumbnailManager)
    {
        super();
