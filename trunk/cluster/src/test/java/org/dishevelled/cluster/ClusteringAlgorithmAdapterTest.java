...
/**
 * Unit test for ClusteringAlgorithmAdapter.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class ClusteringAlgorithmAdapterTest
    extends TestCase
{

    public void testConstructor()
    {
        ClusteringAlgorithmAdapter<String> adapter0 = new ClusteringAlgorithmAdapter<String>();
    }

    public void testExitFailed()
    {
        ClusteringAlgorithmAdapter<String> adapter = new ClusteringAlgorithmAdapter<String>();
        adapter.exitFailed(new ClusteringAlgorithmEvent<String>(new TestClusteringAlgorithm<String>()));
    }

    public void testExitSucceeded()
    {
        ClusteringAlgorithmAdapter<String> adapter = new ClusteringAlgorithmAdapter<String>();
