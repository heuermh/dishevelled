...
/**
 * JTextComponent with KEY_TEXT_ANTIALIASING set to VALUE_TEXT_ANTIALIAS_LCD_HRGB.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class JTextComponentAntialiasingLcdHrgb
    extends AbstractJTextComponentTextRenderingBenchmark
{
    ...
    {
        return "jtextcomponent-lcd-hrgb";
    }
