...
/**
 * JTextComponent with KEY_TEXT_ANTIALIASING set to VALUE_TEXT_ANTIALIAS_LCD_HBGR.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class JTextComponentAntialiasingLcdHbgr
    extends AbstractJTextComponentTextRenderingBenchmark
{
    ...
    {
        return "jtextcomponent-lcd-hbgr";
    }
