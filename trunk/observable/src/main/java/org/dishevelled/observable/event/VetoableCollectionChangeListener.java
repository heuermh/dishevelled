 ...
 * changes about to be made to an observable collection.
 *
    ...
    extends EventListener
{
     ...
     * to be made to the observable collection.
     *
     * @param e vetoable collection change event
     * @throws CollectionChangeVetoException if this listener wishes
