...
/**
 * Unit test for ObservableGraphImpl that delegates to an immutable graph.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class ImmutableObservableGraphTest
    extends AbstractObservableGraphTest
{
    ...
    {
        Graph<N, E> emptyGraph = GraphUtils.createGraph();
        Graph<N, E> immutableGraph = GraphUtils.unmodifiableGraph(emptyGraph);
        return new ObservableGraphImpl<N, E>(immutableGraph);
    }
    ...
    protected <N, E> ObservableGraph<N, E> createFullObservableGraph(final N nodeValue, final E edgeValue)
    {
        ...
        Graph<N, E> immutableGraph = GraphUtils.unmodifiableGraph(fullGraph);
        return new ObservableGraphImpl<N, E>(immutableGraph);
    }
}