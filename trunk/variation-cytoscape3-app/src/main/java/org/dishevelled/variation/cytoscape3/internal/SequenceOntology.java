 ...
 */
final class SequenceOntology
{
    private static final AtomicInteger id = new AtomicInteger(0);

    static Map<String, Concept> indexByName(final Domain domain)
    {
    ...
    static Map<Concept, Integer> countAssignments(final Domain domain)
    {
    ...
    static Domain sequenceFeatures()
    {
    ...
    static Domain sequenceVariants()
    {
        Authority so = new Authority("so");
        Domain sv = so.createDomain("sv" + id.incrementAndGet());

        Concept _3_prime_UTR_variant = sv.createConcept("3_prime_UTR_variant", "SO:0000000", null);
        Concept _5_prime_UTR_variant = sv.createConcept("5_prime_UTR_variant", "SO:0000000", null);
        Concept coding_sequence_variant = sv.createConcept("coding_sequence_variant", "SO:0000000", null);
        Concept downstream_gene_variant = sv.createConcept("downstream_gene_variant", "SO:0000000", null);
        Concept exon_variant = sv.createConcept("exon_variant", "SO:0000000", null);
        Concept feature_ablation = sv.createConcept("feature_ablation", "SO:0000000", null);
        Concept feature_amplification = sv.createConcept("feature_amplification", "SO:0000000", null);
        Concept feature_elongation = sv.createConcept("feature_elongation", "SO:0000000", null);
        Concept feature_truncation = sv.createConcept("feature_truncation", "SO:0000000", null);
        Concept feature_variant = sv.createConcept("feature_variant", "SO:0000000", null);
        Concept frameshift_variant = sv.createConcept("frameshift_variant", "SO:0000000", null);
        Concept gene_variant = sv.createConcept("gene_variant", "SO:0000000", null);
        Concept incomplete_terminal_codon_variant = sv.createConcept("incomplete_terminal_codon_variant", "SO:0000000", null);
        Concept inframe_deletion = sv.createConcept("inframe_deletion", "SO:0000000", null);
        Concept inframe_indel = sv.createConcept("inframe_indel", "SO:0000000", null);
        Concept inframe_insertion = sv.createConcept("inframe_insertion", "SO:0000000", null);
        Concept inframe_variant = sv.createConcept("inframe_variant", "SO:0000000", null);
        Concept initiator_codon_variant = sv.createConcept("initiator_codon_variant", "SO:0000000", null);
        Concept intergenic_variant = sv.createConcept("intergenic_variant", "SO:0000000", null);
        Concept internal_feature_elongation = sv.createConcept("internal_feature_elongation", "SO:0000000", null);
        Concept intron_variant = sv.createConcept("intron_variant", "SO:0000000", null);
        Concept mature_miRNA_variant = sv.createConcept("mature_miRNA_variant", "SO:0000000", null);
        Concept missense_variant = sv.createConcept("missense_variant", "SO:0000000", null);
        Concept nc_transcript_variant = sv.createConcept("nc_transcript_variant", "SO:0000000", null);
        Concept _NMD_transcript_variant = sv.createConcept("NMD_transcript_variant", "SO:0000000", null);
        Concept non_coding_exon_variant = sv.createConcept("non_coding_exon_variant", "SO:0000000", null);
        Concept protein_altering_variant = sv.createConcept("protein_altering_variant", "SO:0000000", null);
        Concept regulatory_region_ablation = sv.createConcept("regulatory_region_ablation", "SO:0000000", null);
        Concept regulatory_region_amplification = sv.createConcept("regulatory_region_amplification", "SO:0000000", null);
        Concept regulatory_region_variant = sv.createConcept("regulatory_region_variant", "SO:0000000", null);
        Concept sequence_variant = sv.createConcept("sequence_variant", "SO:0000000", null);
        Concept splice_acceptor_variant = sv.createConcept("splice_acceptor_variant", "SO:0000000", null);
        Concept splice_donor_variant = sv.createConcept("splice_donor_variant", "SO:0000000", null);
        Concept splice_region_variant = sv.createConcept("splice_region_variant", "SO:0000000", null);
        Concept splice_site_variant = sv.createConcept("splice_site_variant", "SO:0000000", null);
        Concept splicing_variant = sv.createConcept("splicing_variant", "SO:0000000", null);
        Concept stop_gained = sv.createConcept("stop_gained", "SO:0000000", null);
        Concept stop_lost = sv.createConcept("stop_lost", "SO:0000000", null);
        Concept stop_retained_variant = sv.createConcept("stop_retained_variant", "SO:0000000", null);
        Concept structural_variant = sv.createConcept("structural_variant", "SO:0000000", null);
        Concept synonymous_variant = sv.createConcept("synonymous_variant", "SO:0000000", null);
        Concept terminator_coding_variant = sv.createConcept("terminator_coding_variant", "SO:0000000", null);
        Concept terminator_codon_variant = sv.createConcept("terminator_codon_variant", "SO:0000000", null);
        Concept _TF_binding_site_variant = sv.createConcept("TF_binding_site_variant", "SO:0000000", null);
        Concept _TFBS_ablation = sv.createConcept("TFBS_ablation", "SO:0000000", null);
        Concept _TFBS_amplification = sv.createConcept("TFBS_amplification", "SO:0000000", null);
        Concept transcript_ablation = sv.createConcept("transcript_ablation", "SO:0000000", null);
        Concept transcript_amplification = sv.createConcept("transcript_amplification", "SO:0000000", null);
        Concept transcript_variant = sv.createConcept("transcript_variant", "SO:0000000", null);
        Concept upstream_gene_variant = sv.createConcept("upstream_gene_variant", "SO:0000000", null);
        Concept _UTR_variant = sv.createConcept("UTR_variant", "SO:0000000", null);
        ...
        sv.createRelation("is_a", terminator_coding_variant, coding_sequence_variant);
