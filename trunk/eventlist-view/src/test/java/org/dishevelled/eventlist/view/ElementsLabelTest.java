...
/**
 * Unit test for ElementsLabel.
 */
public final class ElementsLabelTest
{
    private EventList<String> elements;
    private ElementsLabel<String> elementsLabel;

    @Before
    public void setUp()
    {
        elements = GlazedLists.eventListOf("foo", "bar", "baz");
        elementsLabel = new ElementsLabel<String>(elements);
    }

    @Test
    public void testConstructor()
    {
        assertNotNull(elementsLabel);
    }

    @Test(expected=IllegalArgumentException.class)
    public void testConstructorNullModel()
    {
        new ElementsLabel<String>(null);
    }
}
