...
/**
 * Unit test for ElementsList.
 */
public final class ElementsListTest
{
    private EventList<String> elements;
    private ElementsList<String> elementsList;

    @Before
    public void setUp()
    {
        elements = GlazedLists.eventListOf("foo", "bar", "baz");
        elementsList = new ElementsList<String>(elements);
    }
    ...
    {
        new ElementsList<String>(null);
    }

    @Test
    public void testConstructorLabelText()
    {
        assertNotNull(new ElementsList<String>("labelText", elements));
    }

    @Test
    public void testConstructorNullLabelText()
    {
        assertNotNull(new ElementsList<String>(null, elements));
    }

    @Test(expected=IllegalArgumentException.class)
    public void testConstructorLabelTextNullModel()
    {
        new ElementsList<String>("labelText", null);
    }
}
