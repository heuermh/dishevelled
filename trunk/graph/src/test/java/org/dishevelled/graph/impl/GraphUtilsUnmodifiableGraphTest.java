...
/**
 * Unit test for the implementation of graph returned by
 * <code>GraphUtils.unmodifibleGraph(Graph)</code>.
 *
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public final class GraphUtilsUnmodifiableGraphTest
    extends AbstractGraphTest
{
    ...
    protected <N, E> Graph<N, E> createFullGraph(final N nodeValue, final E edgeValue)
    {
        ...
        return GraphUtils.unmodifiableGraph(graph);
    }
}