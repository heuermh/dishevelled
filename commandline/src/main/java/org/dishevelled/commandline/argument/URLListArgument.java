 ...
 */
public final class URLListArgument
    extends AbstractArgument<List<URL>>
{
     ...
     */
    public URLListArgument(final String shortName,
    ...
    /** {@inheritDoc} */
    protected List<URL> convert(final String s)
        throws Exception
    {
