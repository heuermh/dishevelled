 ...
 * made to an observable navigable set.
 *
 * @param <E> navigable set element type
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public interface NavigableSetChangeListener<E>
    extends EventListener
{

    /**
     * Notify this listener that a change has been
     * made to the observable navigable set.
     *
     * @param e navigable set change event
     */
    void navigableSetChanged(NavigableSetChangeEvent<E> e);
}
