 ...
 */
public abstract class AbstractMatrix3DWriter<E>
    implements Matrix3DWriter<E>
{

    /** {@inheritDoc} */
    public final void write(final Matrix3D<? extends E> matrix, final File file) throws IOException
    {
        if (matrix == null)
        {
    ...
    /** {@inheritDoc} */
    public final void write(final Matrix3D<? extends E> matrix, final OutputStream outputStream) throws IOException
    {
        if (matrix == null)
        {
            throw new IllegalArgumentException("matrix must not be null");
