 ...
 * The first line should be the size of the matrix as <code>rows\tcolumns\tcardinality</code>
 * and each additional line should be formatted as <code>row\tcolumn\tvalue</code>.
 *
 * @param <E> 2D matrix element type
 * @author  Michael Heuer
 * @version $Revision$ $Date$
 */
public abstract class AbstractTextMatrix2DReader<E>
    extends AbstractMatrix2DReader<E>
{

    /** {@inheritDoc} */
    public final Matrix2D<E> read(final InputStream inputStream) throws IOException
    {
        if (inputStream == null)
        {
