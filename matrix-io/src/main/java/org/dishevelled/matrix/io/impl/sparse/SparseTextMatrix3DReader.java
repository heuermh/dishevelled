 ...
 */
public final class SparseTextMatrix3DReader<E>
    extends AbstractSparseTextMatrix3DReader<E>
{
    /** Parser function. */
     ...
     */
    public SparseTextMatrix3DReader(final UnaryFunction<String, ? extends E> parser)
    {
        if (parser == null)
        {
